...
//
//   Template.idNetwork.onCreated(function() {
//     // bubbleCloud = forceLayoutNetwork();
//   //  force  = d3.layout.force();
//   }); // onCreated()
//
//
...
//     // var avatarSize = 150;
//
//     // We instantiate our forceLayoutNetwork modul.
//     // After that, we can use our getter-setter methods
//     // for modifying or retrieving property values.
//     bubbleCloud = forceLayoutNetwork();
//
//     // We retrieve the current browser viewport size.
//     var clientWidth = document.documentElement.clientWidth;
//     var clientHeight = document.documentElement.clientHeight - bubbleCloud.avatarSize();
//
//     // var outerRadius = Math.min(clientWidth, clientHeight - avatarSize / 2) / 2 - avatarSize / 2;
//     // var bubbleRadius = Math.floor(outerRadius * 0.1);
//
//     // We set the dimensions of our bubble visualization.
//     bubbleCloud
//       .width(clientWidth)
//       .height(clientHeight);
//
...
//     var currentTrainingId = currentUser.profile.currentTraining;
//     var currentPlayers = Meteor.users.find({"profile.currentTraining": currentTrainingId}).fetch();
//     cloudData.players = currentPlayers;
//     // var playersConfig =  {
//     //   radius: outerRadius,
//     //   centerX: clientWidth / 2,
//     //   centerY: clientHeight / 2,
...
//     //
//     // createPlayersCircle(currentPlayers, playersConfig);
//     bubbleCloud("#ids-graph", cloudData);
//     templateInstance.autorun(function() {
//
//     // var currentNetworkIds = MetaCollection.find({
//     //   $nor: [
...
//         // dataset = arrangeData(currentPlayers, currentNetworkIds);
//         // createBubbleCloud(outerRadius, clientWidth, clientHeight, playersConfig, dataset, drawingSurface);
//         // cloudData = addToNetworkIds(doc);
//         // // cloudData.links = arrangeData(cloudData.players, cloudData.networkIds);
//         // console.log("cloudData ", cloudData);
//         // bubbleCloud.updateData(cloudData);
//       },
//       changed: function(newDoc,oldDoc) {
//
//       },
//       removed: function(doc) {
//         cloudData.networkIds = removeFromNetworkIds(doc);
//         // cloudData.links = arrangeData(cloudData.players, cloudData.networkIds);
//         bubbleCloud.updateData(cloudData);
//         // dataset = arrangeData(currentPlayers, currentNetworkIds);
//         // createBubbleCloud(outerRadius, clientWidth, clientHeight, playersConfig, dataset, drawingSurface);
...
//     // }
//
//     for (var i = 0; i < cloudData.networkIds.length; i++) {
//         // console.log(currentNetworkIds[i]);
//         // console.log(metaId);
//       if (cloudData.networkIds[i].name == metaId.name) {
//         return console.log("already in");
//       }
//     }
//         var newNetworkId = _.extend(metaId, {matchCount: metaId.createdBy.length});
...
//         // currentNetworkIds.push(newNetworkId);
//         // return currentNetworkIds;
//         cloudData.networkIds.push(newNetworkId);
//         cloudData.links = arrangeData(cloudData.players, cloudData.networkIds);
//         bubbleCloud.updateData(cloudData);
//         // bubbleCloud.updateData(newNetworkId);
//   };
//
//   var removeFromNetworkIds = function(metaId) {
//     currentNetworkIds.forEach(function(networkId, i, network) {
